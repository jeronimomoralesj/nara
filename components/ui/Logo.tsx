  ...
  return (
    <span className={cn("inline-flex items-center gap-2.5", className)}>
      ...
      {!markOnly && (
        ...
        >
          Fundación&nbsp;<span className="text-terracotta-500">Nara</span>
        </span>
      )}
    </span>
  );
...
/** The standalone icon mark — a terracotta badge with an embrace/heart. */
export function LogoMark({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <circle cx="15.2" cy="13.4" r="2.1" fill="#FBF4F0" />
      <circle cx="24.8" cy="13.4" r="2.1" fill="#FBF4F0" />
    </svg>
  );
}
